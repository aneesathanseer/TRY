...
BEGIN
	...
	WHERE (AirBnkPaymnt.Active = 1)
		...
		AND AirBnkPaymnt.ReceiptID = @ReceiptID --jinil last retdfdfdsfrsdaddsssadsasdfdsfetetretretert public from fghjlkjlkjlkjlkfhgffj try jinil dfdgfdf dsfdf cfghgfhgfh test
END
